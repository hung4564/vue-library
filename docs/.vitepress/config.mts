...
export default defineConfig({
  ...
  rewrites: {
    ...
    'libs/share/shared/src/:pkg/index.md': 'shared/:pkg/index.md',
    'libs/share/core/src/:pkg/index.md': 'shared-core/:pkg/index.md',
    'libs/share/file/src/:pkg/index.md': 'shared-file/:pkg/index.md',
