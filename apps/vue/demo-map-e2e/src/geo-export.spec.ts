...
test.describe('vue-demo-map geo-export smoke', () => {
  test('loads geo-export demo with layers', async ({ page }) => {
    test.setTimeout(90_000);
    await page.goto('/demo-map/vue/#/dataset-geo-export/');
    ...
    await expect(page.locator('.geo-export-demo-legend')).toBeVisible({
      timeout: 15_000,
    });
  });
});
