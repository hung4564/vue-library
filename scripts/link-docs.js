...
const links = [
  {
    source: path.resolve(__dirname, '../libs/vue/map-core/docs'),
    target: path.resolve(__dirname, '../docs/pages/map/core'),
  },
  {
    source: path.resolve(__dirname, '../libs/vue/map-dataset/docs'),
    target: path.resolve(__dirname, '../docs/pages/map/dataset'),
  },
  {
    source: path.resolve(__dirname, '../libs/vue/map-draw/docs'),
