 ...
 *   node scripts/sync-workspace-peers.js shared-log
...
if (!group || !GROUPS[group]) {
  console.error(
    'Usage: node scripts/sync-workspace-peers.js <draggable|map|shared-store|shared-log> [--dry-run]',
  );
  process.exit(1);
}
