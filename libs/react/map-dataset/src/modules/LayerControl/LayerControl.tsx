...
export function LayerControl(props: LayerControlProps) {
      ...
      map: {
        'layer-control': {
          ...
          field: {
            ...
            minzoom: 'Min zoom',
            maxzoom: 'Max zoom',
            bound: { minx: 'Min Longitude', miny: 'Min Latitude', maxx: 'Max Longitude', maxy: 'Max Latitude' },
          },
        },
      },
    });
  ...
  return (
    <ModuleContainer
      ...
      btn={
        state ? (
          <MapCommonButton option={state} onClick={(e) => {
            e.stopPropagation();
    ...
    >
      <CreateControl mapId={mapId} show={showCreate} onShowChange={toggleShowCreate} />
      {props.children}
