/**
 * Locks `@hungpvq/react-map-dataset` root **runtime** export surface.
...
describe('public API surface', () => {
  it('root runtime exports match Stable + Experimental allowlists', () => {
    ...
    const expected = [...REACT_MAP_DATASET_STABLE_RUNTIME_EXPORTS, ...REACT_MAP_DATASET_EXPERIMENTAL_RUNTIME_EXPORTS].sort();
