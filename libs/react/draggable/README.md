...
Peers: `react` / `react-dom` `^18`, `@hungpvq/draggable@<!-- docs-ver:draggable.peer -->^1.3.0<!-- /docs-ver:draggable.peer -->`, `react-rnd`, plus shared packages listed in `package.json`.
