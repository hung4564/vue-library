/**
 * Shell locales (English). Aggregated by `locale/locale.en.ts`.
 * Domain: `<domain>/locale.en.ts` · VI: `locale.vi.ts` · Pack: `locale/locale.<lang>.ts`.
 */
...
export const LANGUAGE_CONTROL_LOCALE = {
  map: {
    'language-control': {
      title: 'Language',
      en: 'English',
