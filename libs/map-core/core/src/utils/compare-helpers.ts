/**
 * Framework-agnostic map comparison utilities
 * Provides swiper functionality for comparing two map instances
 */

/**
 * Creates a horizontal swiper for map comparison
 * Allows dragging to reveal different parts of two maps
 *
 * @param handleEl - The draggable handle element
 * @param div1 - First map container element
 * @param div2 - Second map container element
 * @returns Object with clear and resize functions
 */
...
/**
 * Creates a vertical swiper for map comparison
 * Allows dragging to reveal different parts of two maps vertically
 *
 * @param handleEl - The draggable handle element
 * @param div1 - First map container element
 * @param div2 - Second map container element
