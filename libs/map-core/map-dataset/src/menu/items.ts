...
export const LIST_VIEW_MENU_COMPONENT_KEY = {
  ...
  attributeTable: 'attribute-table',
  attributeTableView: 'attribute-table-view',
  attributeTableToolbar: 'attribute-table-toolbar',
  attributeTablePager: 'attribute-table-pager',
  attributeTableGrid: 'attribute-table-grid',
