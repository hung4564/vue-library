...
import LayerComponent from './part/layer-component.vue';
...
<template>
  <ModuleContainer v-bind="moduleContainerProps">
    ...
    <template #draggable="props">
      ...
      >
        ...
        <div class="layer-control">
          <LayerList :mapId="mapId" @click:create="openAddLayer()" />
    ...
    <LayerCreateControl v-model:show="showCreate" />
    <LayerComponent v-for="item of views" :key="item.id" :item="item" />
    <slot />
  </ModuleContainer>
</template>
