...
Docs-only and test-only changes are **patch**. Changing documented a11y/store behavior needs a SemVer decision — see [README checklist](../../README.md#checklist-semver--breaking-change).
