...
Docs-only and test-only changes are **patch** on the current published line (`<!-- docs-ver:draggable.line -->1.1.x<!-- /docs-ver:draggable.line -->`). Changing documented a11y/store behavior needs a SemVer decision — see [README checklist](../../README.md#checklist-semver--breaking-change).
