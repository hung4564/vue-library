...
4. Prefer peer ranges like `^<!-- docs-ver:draggable.exact -->1.3.0<!-- /docs-ver:draggable.exact -->` over long-lived exact pins once release process is stable; adapters currently use `<!-- docs-ver:draggable.peer -->^1.3.0<!-- /docs-ver:draggable.peer -->`.
